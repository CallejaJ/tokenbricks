...
import { Bed, Bath, Square, MapPin, BatteryMedium as Ethereum } from "lucide-react"
...
const mockProperties = [
  {
    ...
    description: "A stunning modern loft in the heart of downtown with floor-to-ceiling windows and premium finishes.",
    attributes: [
  ...
  },
  {
    ...
    description: "Exclusive beachfront property with panoramic ocean views and private beach access.",
    attributes: [
  ...
  },
  {
    ...
    description: "Cozy mountain retreat with breathtaking views and rustic charm, perfect for year-round living.",
    attributes: [
  ...
  },
  {
    ...
    description: "Spectacular penthouse with 360-degree city views, rooftop terrace, and luxury amenities.",
    attributes: [
            ...
            >
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="font-semibold text-lg text-slate-900 line-clamp-1">{property.name}</h3>
                ...
                <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={() => setSelectedProperty(property)}>
                  View Details
                </Button>
              </CardContent>
            </Card>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center p-3 bg-slate-50 rounded-lg">
                        ...
                        <div className="font-semibold">{selectedProperty.attributes[2].value}</div>
                        <div className="text-sm text-slate-600">Bedrooms</div>
                      </div>
                      <div className="text-center p-3 bg-slate-50 rounded-lg">
                        <Bath className="w-6 h-6 mx-auto mb-1 text-slate-600" />
                        <div className="font-semibold">{selectedProperty.attributes[3].value}</div>
                        <div className="text-sm text-slate-600">Bathrooms</div>
                      </div>
                      <div className="text-center p-3 bg-slate-50 rounded-lg">
                        <Square className="w-6 h-6 mx-auto mb-1 text-slate-600" />
                        <div className="font-semibold">{selectedProperty.attributes[4].value}</div>
                    ...
                    {!account ? (
                      <div className="mb-6">
                        <p className="text-slate-600 mb-4">Connect your wallet to interact with this property</p>
                      ...
                      <div className="mb-6">
                        <div className="flex gap-3 mb-4">
                          <Button className="flex-1 bg-blue-600 hover:bg-blue-700">Buy Property</Button>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedProperty.attributes.map((attr, index) => (
                          ...
                          >
                            <span className="text-slate-600">{attr.trait_type}</span>
